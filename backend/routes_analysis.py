...
# Import services
from feedback_service import FeedbackService # type: ignore
...
from auth import verify_api_key # pyright: ignore[reportMissingImports]

# Import rate limiting
from rate_limit import limiter_with_api_key, STRICT_RATE_LIMIT, DEFAULT_RATE_LIMIT # pyright: ignore[reportMissingImports]
...
async def get_embedding_status(api_key: str = Depends(verify_api_key)):
    ...
    from embedding_service import embedding_service # pyright: ignore[reportMissingImports]
